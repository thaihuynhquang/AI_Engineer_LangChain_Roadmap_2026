...
Dành cho lập trình viên muốn chuyển mình sang **AI Engineer** thông qua việc xây dựng sản phẩm thực tế (Production-ready AI Application) dựa trên **lộ trình tự học 100% bằng tài nguyên online miễn phí (`docs/content/online_learning_guide.md`)** và hệ sinh thái công nghệ cập nhật tháng 7/2026.
...
* **Module tự học Online**: **Module 1 trong `docs/content/online_learning_guide.md`**
...
* **Module tự học Online**: **Module 2 trong `docs/content/online_learning_guide.md`**
...
* **Module tự học Online**: **Module 3 trong `docs/content/online_learning_guide.md`**
...
* **Module tự học Online**: **Module 4 trong `docs/content/online_learning_guide.md`**
...
* **Module tự học Online**: **Module 5 trong `docs/content/online_learning_guide.md`**
